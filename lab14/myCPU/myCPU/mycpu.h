`ifndef MYCPU_H
    ...
    `define FS_TO_DS_BUS_WD 137  // plus one for excpetion signal, and 5 bits for excode
    //`define DS_TO_ES_BUS_WD 221
    `define DS_TO_ES_BUS_WD 285
    //`define ES_TO_MS_BUS_WD 117
    `define ES_TO_MS_BUS_WD 185
    //`define MS_TO_WS_BUS_WD 70
    `define MS_TO_WS_BUS_WD 138
